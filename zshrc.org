...
- [[#functions][Functions]]
  ...
  - [[#org-toc-update][org-toc-update]]
  - [[#feh][feh]]
  - [[#feh-1][feh]]
  - [[#play][play]]
  - [[#duplicateseachdirectoryseparatelyremove][duplicateseachdirectoryseparatelyremove]]
  - [[#ftpplay][ftpplay]]
  - [[#ccr][ccr]]
...
- [[#aliases][Aliases]]
  ...
  - [[#function-aliases][Function Aliases]]
   ...
   - [[#bat][Bat]]
    - [[#batcat][bat/cat]]
    - [[#batmanman][batman/man]]
    - [[#batwatchwatch][batwatch/watch]]
    - [[#batdiffdiff][batdiff/diff]]
...
- [[#zsh-autocomplete-tab-fix][zsh-autocomplete tab-fix]]
- [[#tmate-run][TMATE run]]
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    static_username       # example user-defined segment (see prompt_example function below)
    # =========================[ Line #1 ]=========================
    newline               # \n
...
# Make Tab go to the menu, and Shift-Tab go backwards
bindkey '\t' menu-complete
bindkey "$terminfo[kcbt]" reverse-menu-complete

# Enter always submits the command
...
# 2. Force classic Zsh behavior
zstyle ':autocomplete:*' default-context ''  # Don't start completing on empty lines
zstyle ':autocomplete:*' delay 0.2           # Add a slight delay before showing results

# bindkey -M menuselect '^M' .accept-line      # Enter executes command
bindkey '\t' menu-complete                   # Tab cycles through


# Load the list-colors module
zmodload zsh/complist

# Enable visual selection (highlighting) in the menu
zstyle ':completion:*' menu select

# Define the highlight style (ma = Match)
# 7;1 makes it "Standout/Reverse video" + "Bold"
